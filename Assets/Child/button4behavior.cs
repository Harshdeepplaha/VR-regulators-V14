...
public class button4behavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (atStart && introTimer < introLength || audioSource.isPlaying || childState.tantrumLevel == 0 || tatrumchildbehavior.gameLost) // if the child is saying the greeting -> not show the button
